--TODO: This model is not generating any results, figure out why
...
final AS (
    SELECT
        ...
        DATE_PART(DAY, starts_at) AS payment_day,
        ...
        is_subscribed_previous_month,
        first_subscription_month,
        last_subscription_month,
        is_first_subscription_month,
        is_last_subscription_month,
        DATE(DATE_TRUNC('month', starts_at)) = DATE(DATE_TRUNC('month', COALESCE(ends_at, '9999-12-31'))) AS is_m1_churn,
